...
const SOCIAL_LINKS = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/share/1EhgJBE3Le/",
    icon: <FacebookFilled />,
  },
  {
    name: "Instagram",
    href: "https://www.instagram.com/gardenia_world_school/?utm_source=qr&igsh=MmFsd29iem9kODQ4#",
    icon: <InstagramFilled />,
  },
  {
    name: "YouTube",
    href: "https://www.youtube.com/@Gardenia_World_School",
    icon: <YoutubeFilled />,
  },
];
      ...
      <div className="container max-w-6xl flex flex-col mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full justify-between gap-20">
          <div className="flex flex-col gap-4">
            <Image
              src="/image/logos/logo-footer.jpeg"
              alt="logo"
              width={200}
              height={200}
            />
            <Typography variant="paragraph" color="white" className="mb-3">
              ...
              Doloremque ad pariatur corporis praesentium. Incidunt corporis
              debitis totam modi! Facilis quas assumenda
            </Typography>
